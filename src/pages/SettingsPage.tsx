...
const SettingsPage = () => {
  ...
  const baseCardClass = "bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md";
    ...
    <div>
      ...
      <div className="max-w-xl mx-auto space-y-8">
        ...
        <div className={baseCardClass}>
          <h2 className="text-xl font-semibold mb-4">Règle Budgétaire (%)</h2>
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-4">
              <div>
                <label htmlFor="needs" className={labelClass}>Besoins</label>
                <input {...register('needs')} type="number" id="needs" className={baseInputClass} />
              </div>
              <div>
                <label htmlFor="wants" className={labelClass}>Envies</label>
                <input {...register('wants')} type="number" id="wants" className={baseInputClass} />
              </div>
              <div>
                <label htmlFor="savings" className={labelClass}>Épargne</label>
                <input {...register('savings')} type="number" id="savings" className={baseInputClass} />
              </div>
            </div>
            ...
            <div className="mt-6">
              <button type="submit" disabled={isSubmitting || !isDirty} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md disabled:bg-gray-500 disabled:cursor-not-allowed">
        ...
        {/* Section Devise */}
        <div className={baseCardClass}>
          <h2 className="text-xl font-semibold mb-2">Devise</h2>
        ...
        <div className="bg-red-900/20 border border-red-500/30 p-6 rounded-lg">
          ...
          <button
            ...
            className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg transition-transform hover:scale-105"
          >
